...
Use these variables through `theme.components.Switch`. This document lists definitions only and does not include values.
...
| --- | --- | --- |
| `trackHeight` | `string \| number` | Height of Switch |
| `trackHeightSM` | `string \| number` | Height of small Switch |
| `trackMinWidth` | `string \| number` | Minimum width of Switch |
| `trackMinWidthSM` | `string \| number` | Minimum width of small Switch |
